...
{
    public sealed class Units(Book book)
    {
        ...
        public Merge Merge(Content content, Size size, Style style) =>
            Merge(content, size, book.Styles.Register(style));

        public Merge Merge(string value, Size size, StyleId? styleId = null) =>
            new(size, new String(value, book.Strings), styleId);

        public Merge Merge(string value, Size size, Style style) => Merge(value, size, book.Styles.Register(style));

        public Merge Merge(long value, Size size, StyleId? styleId = null) =>
            new(size, new Number.Integral(value), styleId);

        public Merge Merge(long value, Size size, Style style) => Merge(value, size, book.Styles.Register(style));

        public Merge Merge(double value, Size size, StyleId? styleId = null) =>
            new(size, new Number.Fractional(value), styleId);

        public Merge Merge(double value, Size size, Style style) => Merge(value, size, book.Styles.Register(style));

        public Merge Merge(decimal value, Size size, StyleId? styleId = null) =>
            new(size, new Number.Financial(value), styleId);
        ...
        public Merge Merge(Expression value, Size size, StyleId? styleId = null) =>
            new(size, new Formula(value), styleId);
