...
public sealed class Units
{
    ...
    public Merge Merge(long value, Size size, StyleId? styleId = null) => new(new Number.Integral(value), size, styleId);
    public Merge Merge(long value, Size size, Style style) => Merge(value, size, book.Styles.Register(style));

    public Merge Merge(double value, Size size, StyleId? styleId = null) => new(new Number.Fractional(value), size, styleId);
    public Merge Merge(double value, Size size, Style style) => Merge(value, size, book.Styles.Register(style));

    public Merge Merge(decimal value, Size size, StyleId? styleId = null) => new(new Number.Financial(value), size, styleId);
    ...
    public Merge Merge(Expression value, Size size, StyleId? styleId = null) => new(new Formula(value), size, styleId);
